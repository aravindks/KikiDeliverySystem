...
describe('create shipment', () => {
  it('should create shipment in accord to specified weight', () => {
    ...
    expect(shipments.packageLists[0].packages[0].weight).toBeLessThan(MAX_WEIGHT);
    expect(shipments.packageLists[1].packages[0].weight).toBeLessThan(MAX_WEIGHT);
    expect(shipments.packageLists[2].packages[0].weight + shipments.packageLists[2].packages[1].weight).toBeLessThan(MAX_WEIGHT);
    expect(shipments.packageLists[3].packages[0].weight).toBeLessThan(MAX_WEIGHT);
  })
